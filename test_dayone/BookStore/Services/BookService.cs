    ...
    public class BookService : IBookService
    {
       ...
       public BookService(BookStoreContext context)
        ...
        public async Task<int> Delete(int bookId)
        {
            ...
            if(book == null)
            {
                throw new System.Exception("can't find book");
            }
        ...
        public async Task<BookViewModel> GetBookById(int id)
        {
            ...
            var categories = await (from bic in _context.BookInCategories where bic.BookId == id
        ...
        {
            var query =from b in _context.Books join bc in _context.BookInCategories on b.Id equals bc.BookId
                       join ct in _context.Categories on bc.CategoryId equals ct.Id join aut in _context.Authors on b.Id equals aut.Id
