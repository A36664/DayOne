...
namespace Chess
{
    class Cover
    {
        ...
        public static void PrintList(HashSet<ChessPiece> list)
        {
            Console.Write("[");
            foreach (ChessPiece piece in list)
            {
                Console.Write(piece + " ");
            }
            Console.Write("]");
        ...
        public static void PrintBoard(ChessBoard board, bool[,] possiblePosition)
        {
